/** Pet plugin UI locale — follows Potato console ``localStorage.language``. */
...
const messages = {
  en: {
    ...
    title: "Potato Pet",
    intro:
      "Installed pets live under your Potato working directory. Start the desktop bridge, then switch the floating pet without restarting Potato.",
    ...
    colAction: "Action",
    switch: "Switch",
    tableEmpty: "No pets found. Run: potato-pet install-pet …",
  ...
  zh: {
    ...
    title: "Potato 桌面宠物",
    intro:
      "已安装的宠物位于 Potato 工作目录下。启动桌面桥接后，可在不重启 Potato 的情况下切换悬浮宠物。",
    startDesktop: "启动桌面宠物",
    importPet: "导入宠物",
    refresh: "刷新",
    petsDirectory: "宠物目录：",
    ...
    colAction: "操作",
    switch: "切换",
    tableEmpty: "未找到宠物。请运行：potato-pet install-pet …",
...
/** Map Potato console language to pet UI locale (non zh/en → en). */
