/** Potato console stores UI language in ``localStorage.language``. */

const LANGUAGE_KEY = "language";
const LANGUAGE_EVENT = "potato-pet-language-change";
...
function installLanguageSetItemHook(): void {
  const marker = "__potatoPetLanguageHook";
...
/** Subscribe to Potato header language switcher (no console changes needed). */
