...
LangString potatoCliPathPageTitle ${LANG_RUSSIAN} "Command line"
LangString potatoCliPathPageSubtitle ${LANG_RUSSIAN} "Choose whether potato is available in terminals."
LangString potatoCliPathPageDescription ${LANG_RUSSIAN} "This adds the bundled potato command to your user PATH. You can change it later by reinstalling or uninstalling Potato Desktop."
LangString potatoCliPathCheckbox ${LANG_RUSSIAN} "Add potato to PATH"
LangString potatoCliPathAdded ${LANG_RUSSIAN} "Added potato to user PATH"
LangString potatoCliPathSkipped ${LANG_RUSSIAN} "Skipped adding potato to user PATH"
LangString potatoCliPathMissing ${LANG_RUSSIAN} "potato.exe was not found; skipped PATH update"
LangString potatoCliPathUpdateFailed ${LANG_RUSSIAN} "Failed to update user PATH"
LangString potatoStopBackendPrompt ${LANG_RUSSIAN} "Potato всё ещё запущен и использует файлы, которые установщику нужно заменить.$\n$\nЗакройте Potato (проверьте системный трей), затем нажмите «Повторить», чтобы продолжить. Нажмите «Отмена», чтобы прервать установку."
