...
LangString potatoCliPathPageTitle ${LANG_ENGLISH} "Command line"
LangString potatoCliPathPageSubtitle ${LANG_ENGLISH} "Choose whether potato is available in terminals."
LangString potatoCliPathPageDescription ${LANG_ENGLISH} "This adds the bundled potato command to your user PATH. You can change it later by reinstalling or uninstalling Potato Desktop."
LangString potatoCliPathCheckbox ${LANG_ENGLISH} "Add potato to PATH"
LangString potatoCliPathAdded ${LANG_ENGLISH} "Added potato to user PATH"
LangString potatoCliPathSkipped ${LANG_ENGLISH} "Skipped adding potato to user PATH"
LangString potatoCliPathMissing ${LANG_ENGLISH} "potato.exe was not found; skipped PATH update"
LangString potatoCliPathUpdateFailed ${LANG_ENGLISH} "Failed to update user PATH"
LangString potatoStopBackendPrompt ${LANG_ENGLISH} "Potato is still running and is using files the installer needs to replace.$\n$\nPlease quit Potato (check the system tray), then click Retry to continue. Click Cancel to abort the installation."
