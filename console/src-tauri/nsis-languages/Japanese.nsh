...
LangString potatoCliPathPageTitle ${LANG_JAPANESE} "Command line"
LangString potatoCliPathPageSubtitle ${LANG_JAPANESE} "Choose whether potato is available in terminals."
LangString potatoCliPathPageDescription ${LANG_JAPANESE} "This adds the bundled potato command to your user PATH. You can change it later by reinstalling or uninstalling Potato Desktop."
LangString potatoCliPathCheckbox ${LANG_JAPANESE} "Add potato to PATH"
LangString potatoCliPathAdded ${LANG_JAPANESE} "Added potato to user PATH"
LangString potatoCliPathSkipped ${LANG_JAPANESE} "Skipped adding potato to user PATH"
LangString potatoCliPathMissing ${LANG_JAPANESE} "potato.exe was not found; skipped PATH update"
LangString potatoCliPathUpdateFailed ${LANG_JAPANESE} "Failed to update user PATH"
LangString potatoStopBackendPrompt ${LANG_JAPANESE} "Potato がまだ実行中で、インストーラーが置き換える必要のあるファイルを使用しています。$\n$\nPotato を終了してから（システムトレイをご確認ください）、「再試行」をクリックして続行してください。「キャンセル」をクリックするとインストールを中止します。"
