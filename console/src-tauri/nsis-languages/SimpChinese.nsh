...
LangString potatoCliPathPageTitle ${LANG_SIMPCHINESE} "命令行"
LangString potatoCliPathPageSubtitle ${LANG_SIMPCHINESE} "选择是否让终端可以直接使用 potato。"
LangString potatoCliPathPageDescription ${LANG_SIMPCHINESE} "这会把随包提供的 potato 命令加入你的用户 PATH。之后可通过重新安装或卸载 Potato Desktop 变更。"
LangString potatoCliPathCheckbox ${LANG_SIMPCHINESE} "将 potato 添加到 PATH"
LangString potatoCliPathAdded ${LANG_SIMPCHINESE} "已将 potato 添加到用户 PATH"
LangString potatoCliPathSkipped ${LANG_SIMPCHINESE} "已跳过添加 potato 到用户 PATH"
LangString potatoCliPathMissing ${LANG_SIMPCHINESE} "未找到 potato.exe，已跳过 PATH 更新"
LangString potatoCliPathUpdateFailed ${LANG_SIMPCHINESE} "更新用户 PATH 失败"
LangString potatoStopBackendPrompt ${LANG_SIMPCHINESE} "Potato 仍在运行，正占用安装程序需要替换的文件。$\n$\n请先退出 Potato（注意查看系统托盘），然后点击“重试”继续；点击“取消”将中止安装。"
