...
LangString potatoCliPathPageTitle ${LANG_PORTUGUESEBR} "Command line"
LangString potatoCliPathPageSubtitle ${LANG_PORTUGUESEBR} "Choose whether potato is available in terminals."
LangString potatoCliPathPageDescription ${LANG_PORTUGUESEBR} "This adds the bundled potato command to your user PATH. You can change it later by reinstalling or uninstalling Potato Desktop."
LangString potatoCliPathCheckbox ${LANG_PORTUGUESEBR} "Add potato to PATH"
LangString potatoCliPathAdded ${LANG_PORTUGUESEBR} "Added potato to user PATH"
LangString potatoCliPathSkipped ${LANG_PORTUGUESEBR} "Skipped adding potato to user PATH"
LangString potatoCliPathMissing ${LANG_PORTUGUESEBR} "potato.exe was not found; skipped PATH update"
LangString potatoCliPathUpdateFailed ${LANG_PORTUGUESEBR} "Failed to update user PATH"
LangString potatoStopBackendPrompt ${LANG_PORTUGUESEBR} "O Potato ainda está em execução e está usando arquivos que o instalador precisa substituir.$\n$\nFeche o Potato (verifique a bandeja do sistema) e clique em Repetir para continuar. Clique em Cancelar para abortar a instalação."
