...
class BackupMeta(BaseModel):
    ...
    @classmethod
    def _accept_qwenpaw_version(cls, value):
        """Accept metadata written before the Potato rename."""
    ...
    id: str = Field(
        ...
        description="Backup ID (potato-{version}-{timestamp}-{short8})",
    )
    ...
    potato_version: str = Field(
        default="",
        description="Potato version when backup was created",
    )
