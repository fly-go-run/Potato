...
1. ``evacuating_old``: move existing children into ``.potato_restore_old``.
...
OLD_CONTENT_DIR_NAME = ".potato_restore_old"
STATE_FILE_NAME = ".potato_restore_state"
STATE_TMP_FILE_NAME = ".potato_restore_state.tmp"
