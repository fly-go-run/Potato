...
a native filter code (modelscope today, potato once its codes are known)
...
CATEGORIES: list[_Category] = [
    ...
    },
    {
        ...
        "potato": "engineering development",
