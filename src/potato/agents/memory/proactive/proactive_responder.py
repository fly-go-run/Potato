...
async def send_proactive_message_via_http(
    ...
    """Send a proactive message by directly calling the Potato API."""
    ...
    try:
        ...
        logger.error(
            "Timeout (%ds) calling Potato API for proactive message",
            timeout_seconds,
        )
    except Exception as e:
        logger.error("Error calling Potato API for proactive message: %s", e)
