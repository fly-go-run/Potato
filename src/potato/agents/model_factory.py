...
Example:
    >>> from potato.agents.model_factory import create_model_and_formatter
...
def _normalize_messages_for_formatter(
    ...
    if getattr(formatter_instance, "_potato_force_strip_media", False):
        ...
        if not global_model:
            raise ProviderError(
                message=(
                    ...
                    "Please configure a model using 'potato models config' "
...
def _create_formatter_instance(
    ...
    Returns:
        ...
        the model's native one, plus potato extensions for media
