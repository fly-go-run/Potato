...
management. :class:`~potato.agents.react_agent.PotatoAgent` delegates its two
...
class ContextManager(Protocol):
    ...
    async def compress(
        ...
        Called from ``PotatoAgent.compress_context`` in place of the native
    ...
    def on_save(self, agent: Any, blocks: Sequence[Any]) -> None:
        ...
        Called from ``PotatoAgent._save_to_context`` after the base append,
