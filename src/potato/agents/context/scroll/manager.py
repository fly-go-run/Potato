...
subclassing the agent, it is injected into :class:`PotatoAgent` and drives the
two delegated hooks.
...
class ScrollContextManager:
    ...
    def _recall_page_stub(
        ...
        page = cls._block_metadata(block).get("potato_recall_page", {})
        next_cursor = (
