...
def _ensure_playwright_async():
    ...
    try:
        ...
        raise ImportError(
            "Playwright not installed. Use the same Python that runs Potato (e.g. "
...
async def stop_browsers_for_workspace_dirs(
    ...
    directories. It releases Potato-owned Playwright/Chromium handles without
...
async def browser_use(  # pylint: disable=R0911,R0912
    ...
    Args:
        ...
        cdp_port (int):
            ...
            Potato chooses a free local port automatically for managed CDP.
        private_mode (bool):
            ...
            via CDP. Default False. By default, Potato prefers managed CDP for
