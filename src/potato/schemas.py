# -*- coding: utf-8 -*-
"""Potato streaming envelope schema.
...
potato's own envelope protocol — independent of agentscope's internal
event types.
"""
...
# ---------------------------------------------------------------------------
# Message envelope.
# potato's runner constructs an empty ``Message`` then calls
...
# These are constructed by potato rather than parsed from external input
