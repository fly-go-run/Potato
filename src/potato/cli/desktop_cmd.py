# -*- coding: utf-8 -*-
"""CLI command: run Potato app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    if webview is None:
        raise click.ClickException(
            ...
            "Use the supported Potato Tauri desktop app, or install this "
    ...
    click.echo(f"Starting Potato app on {url} (port {port})")
