...
class ToolGovernanceSpec:
    ...
    ``potato.agents.tools`` (treated as a governance gap). Dynamic tools
...
_BUILTIN_TOOLS_PREFIX = "potato.agents.tools."
...
def tool_descriptor(
    ...
    **metadata: Any,
    ...
    Built-in tools (under ``potato.agents.tools``) are automatically
