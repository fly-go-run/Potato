...
from .transcribe_stream import router as transcribe_stream_router
...
from .computer_use import router as computer_use_router
...
router.include_router(transcribe_stream_router)
...
router.include_router(computer_use_router)
