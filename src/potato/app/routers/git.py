...
_DEFAULT_GITIGNORE = """\
# Auto-generated by Potato Coding Mode
...
# Potato runtime / internal directories (not user content)
sessions/
missions/
ralph_loops/
memory/
...
# Potato runtime files
chats.json
jobs.json
skill.json
*.skill.json.lock
.skill.json.lock
potato_file_metadata.json
