# -*- coding: utf-8 -*-
"""
MatrixChannel: Potato BaseChannel implementation for Matrix (via matrix-nio).
...
logger = logging.getLogger("potato.channels.matrix")
...
# Known Potato slash commands — used to decide whether to strip
# @mention prefix
...
class MatrixChannel(BaseChannel):
    """Potato channel that connects to a Matrix homeserver via matrix-nio."""
    ...
    def from_config(
        ...
        return cls(
            ...
            device_name=raw.get("device_name", "potato-worker"),
    ...
    async def _on_room_event(
        ...
        # Skip history prepend for slash commands — Potato's command parser
    ...
    def build_agent_request_from_native(self, native_payload: Any) -> Any:
        ...
        # in the same room share one session (Potato keys session state on
