...
class BaseChannel(ABC):
    ...
    def doctor_connectivity_notes(
        ...
        *,
        ...
        """Optional ``potato doctor --deep`` reachability checks.
    ...
    async def _on_stream_content_delta(
        ...
        from potato.agents.context.scroll.serialize import strip_headline
    ...
    def build_agent_request_from_user_content(
        ...
        Uses :mod:`potato.schemas` Message / Content types directly — no
    ...
    def _clear_session_turn_usage(session_id: str) -> None:
        ...
        mod = importlib.import_module("potato.token_usage.model_wrapper")
        ...
        *,
        ...
        try:
            ...
            turn_usage = importlib.import_module(
                "potato.token_usage.turn_usage",
            )
            token_usage = importlib.import_module("potato.token_usage")
    ...
    async def send_approval_notification(
        ...
        *,
        ...
        back to plain text.
        """
        from potato.schemas import AgentRequest, Event
