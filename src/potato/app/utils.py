...
def schedule_agent_reload(request: "Request", agent_id: str) -> None:
    ...
    Example:
        >>> from potato.app.utils import schedule_agent_reload
...
async def read_upload_with_limit(
    ...
    *,
    ...
    ``POTATO_UPLOAD_MAX_SIZE_MB`` overrides the secure endpoint default.
...
async def save_upload_with_limit(
    ...
    *,
    ...
    ``POTATO_UPLOAD_MAX_SIZE_MB`` value still overrides the endpoint default,
