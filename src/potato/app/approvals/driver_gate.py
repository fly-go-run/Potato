# -*- coding: utf-8 -*-
"""Potato application approval gate for Driver policy."""
...
class PotatoDriverApprovalGate:
    """Bridge Driver policy approval requests into Potato approval service."""

    async def request_approval(
        self,
        context: DriverInvocationContext,
    ) -> None:
        # Reuse Potato's approval Future flow: this coroutine pauses until
