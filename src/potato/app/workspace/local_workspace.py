# -*- coding: utf-8 -*-
"""PotatoLocalWorkspace — routes tool management to ToolRegistry.

Subclasses AgentScope's :class:`LocalWorkspace` so that
:meth:`list_tools` returns Potato's own tools (managed by
...
class PotatoLocalWorkspace(AgentScopeLocalWorkspace):
    ...
    async def list_tools(  # type: ignore[override]
        ...
        *,
        ...
        """Return Potato tools, replacing AgentScope built-ins.
