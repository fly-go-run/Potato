...
from .local_workspace import PotatoLocalWorkspace
...
class Workspace:
    ...
    def __init__(self, agent_id: str, workspace_dir: str):
        ...
        self._local_workspace = PotatoLocalWorkspace(
    ...
    @property
    def local_workspace(self) -> PotatoLocalWorkspace:
