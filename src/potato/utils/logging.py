...
_LOG_BACKUP_COUNT = 3
_LOG_MAX_SIZE_ENV = "POTATO_LOG_MAX_SIZE"
_LOG_BACKUP_COUNT_ENV = "POTATO_LOG_MAX_BACKUPS"
...
def _attach_logger_file_handler(
    ...
    *,
    ...
    (stderr / journald) while also being written to ``potato.log``.
    """
...
def add_project_file_handler(log_path: Path) -> None:
    ...
    override these with POTATO_LOG_MAX_SIZE and POTATO_LOG_MAX_BACKUPS.
