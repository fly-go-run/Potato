...
class LlamaCppBackend:
    """
    Potato local model backend for managing llama.cpp server installation
    and setup.
    """
    ...
    def start_download(
        ...
        spec = ProcessDownloadTaskSpec(
            process_name=f"potato-llamacpp-download-{staging_dir.name}",
            command=["potato-llamacpp-download", download_url],
