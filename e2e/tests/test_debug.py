...
class TestDebugPageDisplay:
    ...
    def test_debug_page_load_and_display(self, page: Page, request: pytest.FixtureRequest):
        ...
        info_alert = page.locator('.potato-alert-info, .potato-alert').first
        ...
        log_card = page.locator('.potato-card').first
        expect(log_card).to_be_visible(timeout=5000)
        card_title = log_card.locator('.potato-card-head-title').first
...
class TestDebugLogControls:
    ...
    def test_debug_log_control_buttons(self, page: Page, request: pytest.FixtureRequest):
        ...
        error_alert = page.locator('.potato-alert-error').first
        ...
        switches = page.locator('.potato-card-extra .potato-switch, .potato-card-head .potato-switch').all()
...
class TestDebugLogLevelFilter:
    ...
    def test_debug_log_level_filter(self, page: Page, request: pytest.FixtureRequest):
        ...
        level_select = page.locator('.potato-select').first
        ...
        for level in expected_levels:
            option = dropdown.locator(f'.potato-select-item:has-text("{level}")').first
        ...
        error_option = dropdown.locator(
            '.potato-select-item:has-text("ERROR"), '
            '.potato-select-item:has(.potato-tag)'
        ).first
        ...
        level_select.click()
        page.wait_for_timeout(500)
        all_option = page.locator('.potato-select-dropdown .potato-select-item').first
...
class TestDebugLogSearch:
    ...
    def test_debug_log_keyword_search(self, page: Page, request: pytest.FixtureRequest):
        ...
        clear_btn = search_input.locator('..').locator('.potato-input-clear-icon').first
...
class TestDebugLogFileInfo:
    ...
    def test_debug_log_file_info(self, page: Page, request: pytest.FixtureRequest):
        ...
        warning_alert = page.locator('.potato-alert-warning').first
