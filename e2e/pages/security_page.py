...
class SecurityPage(BasePage):
    ...
    # Tabs
    TOOL_GUARD_TAB = '[data-node-key="toolGuard"] .potato-tabs-tab-btn'
    FILE_GUARD_TAB = '[data-node-key="fileGuard"] .potato-tabs-tab-btn'

    # Active panel
    ACTIVE_PANEL = '.potato-tabs-tabpane-active'

    # Guard switch
    GUARD_SWITCH = 'button.potato-switch[role="switch"]'

    # Save button
    SAVE_BTN = 'button.potato-btn-primary:has-text("保存"), button:has-text("保 存")'

    # Protected tools select
    PROTECTED_TOOLS_SELECT = '.potato-select'
