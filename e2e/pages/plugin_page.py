# -*- coding: utf-8 -*-
"""
Potato Plugin Manager page object.
...
class PluginPage(BasePage):
    ...
    TAB_INSTALLED = (
        '.potato-tabs-tab:has-text("Installed"), '
        '.potato-tabs-tab:has-text("已安装")'
    )
    TAB_OFFICIAL = (
        '.potato-tabs-tab:has-text("Official"), '
        '.potato-tabs-tab:has-text("官方")'
    )
