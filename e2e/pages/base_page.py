# -*- coding: utf-8 -*-
"""
Potato E2E test framework - Page Object base class.
...
class BasePage:
    ...
    SUCCESS_MESSAGE = '.ant-message-success, .potato-message-success, .potato-notification-success'
    ERROR_MESSAGE = '.ant-message-error, .potato-message-error, .potato-notification-error'
    LOADING_SPINNER = '.ant-spin, .potato-spin, [class*=loading]'
    ...
    def step_shot(self, action: str, full_page: bool = False) -> str:
        ...
        - The test case name is passed through page._potato_test_name (injected by conftest).
        ...
        try:
            ...
            test_name = getattr(self.page, "_potato_test_name", None) or "unknown_test"
            ...
            seq = getattr(self.page, "_potato_step_seq", 0) + 1
            try:
                self.page._potato_step_seq = seq
            except Exception:
                pass
