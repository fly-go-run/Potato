...
class InboxPage(BasePage):
    ...
    TAB_PUSH = (
        '.potato-tabs-tab:has-text("Push Messages"), '
        '.potato-tabs-tab:has-text("推送消息")'
    )
    TAB_APPROVALS = (
        '.potato-tabs-tab:has-text("Approvals"), '
        '.potato-tabs-tab:has-text("审批")'
    )
    ...
    # rendered as <sup class="potato-badge-dot"> inside the menu title.
    # data-menu-id is auto-generated by rc-menu (e.g. "rc-menu-uuid-N-inbox"),
    # so we anchor on the bilingual menu label instead.
    SIDEBAR_INBOX_BADGE = (
        'li.potato-menu-item:has(span.potato-menu-title-content:has-text("Inbox")) '
        '.potato-badge-dot, '
        'li.potato-menu-item:has(span.potato-menu-title-content:has-text("收件箱")) '
        '.potato-badge-dot'
    )

    # Detail modal
    DETAIL_MODAL = '.potato-modal'
    ...
    POPCONFIRM_OK = (
        ...
        '.potato-popover button.potato-btn-primary'
    )
