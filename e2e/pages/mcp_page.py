...
class McpPage(BasePage):
    ...
    CREATE_BTN_SELECTOR = 'button.potato-btn-primary:has-text("创建客户端")'
    ...
    # Create dialog
    MODAL_CONTENT_SELECTOR = '.potato-modal-content'
    MODAL_TITLE_SELECTOR = '.potato-spark-modal-title'
