...
from potato.security.tool_guard.guardians import BaseToolGuardian
from potato.security.tool_guard.guardians.file_guardian import (
    FilePathToolGuardian,
)
from potato.security.tool_guard.guardians.rule_guardian import (
    RuleBasedToolGuardian,
)
from potato.security.tool_guard.models import GuardFinding
...
def file_guardian():
    ...
    with patch(
        "potato.security.tool_guard.guardians.file_guardian"
