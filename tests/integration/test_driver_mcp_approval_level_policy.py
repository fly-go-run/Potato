...
from potato.app.approvals.driver_gate import PotatoDriverApprovalGate
from potato.app.approvals.service import ApprovalService
from potato.app.driver_config_watcher import DriverConfigWatcher
from potato.app.mcp.config_service import MCPConfigService
from potato.app.mcp.schemas import (
    MCPAccessPolicy,
    MCPAccessRule,
    MCPToolDefaultPolicy,
)
from potato.drivers.capabilities import DriverInvocation
from potato.drivers.contracts import (
    DriverCard,
    PolicyRule,
...
async def test_driver_mcp_policy_ask_active_agent_off_auto_allows(
    ...
    monkeypatch.setattr(
        "potato.config.utils.load_config",
