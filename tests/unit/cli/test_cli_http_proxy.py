...
from potato.agents.tools import agent_management
from potato.cli import http as cli_http


# CLI API clients hit the local Potato service, so loopback URLs skip proxies.
