...
import potato.tunnel.binary_manager as bm_module
from potato.tunnel.binary_manager import BinaryManager, _download_file
...
def test_platform_key_returns_tuple(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from potato.tunnel.binary_manager import _platform_key
