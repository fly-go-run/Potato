# -*- coding: utf-8 -*-
"""Tests for potato.security.skill_scanner.analyzers.pattern_analyzer.
...
from potato.security.skill_scanner.analyzers.pattern_analyzer import (
    PatternAnalyzer,
    RuleLoader,
    SecurityRule,
)
...
from potato.security.skill_scanner.scan_policy import (
    CredentialPolicy,
    ScanPolicy,
)
