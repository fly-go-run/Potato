...
"""Tests for potato.security.tool_guard.engine."""
...
from potato.security.tool_guard.engine import (
    ToolGuardEngine,
    _guard_enabled,
    get_guard_engine,
)
...
def _reset_singleton():
    ...
    import potato.security.tool_guard.engine as eng_mod
...
class TestGuardEnabled:
    ...
    @patch("potato.security.tool_guard.engine.EnvVarLoader")
...
class TestGetGuardEngine:
    @patch(
        "potato.security.tool_guard.engine.ToolGuardEngine",
        autospec=True,
    )
