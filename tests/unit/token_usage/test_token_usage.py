...
from potato.token_usage.buffer import (
    TokenUsageBuffer,
    _UsageEvent,
    _apply_event,
)
from potato.token_usage.manager import (
...
from potato.token_usage.storage import load_data, save_data_sync
...
class TestTokenUsageBuffer:
    ...
    async def test_stop_does_not_wipe_history_when_seed_interrupted(
        ...
        monkeypatch.setattr(
            "potato.token_usage.buffer.load_data",
            _never_returns,
        )
