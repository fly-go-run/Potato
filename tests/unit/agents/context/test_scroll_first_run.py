...
import potato.agents.context as context_mod
import potato.agents.context.scroll.manager as scroll_manager_mod
from potato.agents.context import build_scroll_components
from potato.config.config import LightContextConfig
...
def test_first_run_logs_notice_once(tmp_path: Path, caplog):
    ...
    with caplog.at_level(logging.WARNING, logger="potato.agents.context"):
