...
flag AND the deployment-layer ``POTATO_ALLOW_UNSANDBOXED_RECALL`` env var, so
...
from potato.agents.context import scroll_unsandboxed_allowed

_ENV = "POTATO_ALLOW_UNSANDBOXED_RECALL"
