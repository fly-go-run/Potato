...
Welcome to the Potato community! Whether you want to report bugs, seek help, share experiences, or contribute to development, you can reach us through the following channels.

---

## 💬 User Community

For all Potato users: questions, discussions, feature suggestions, and more.
...
- **Share experiences** - Your Potato use cases and tips
...
For contributors focused on development: if you have submitted a PR, claimed a feature, or would like to contribute to Potato development, you are welcome to join the following developer channels (mainly for development collaboration and technical discussions).
...
- **DingTalk Developer Group**: This group is application-based. In your join request note, include one of the following: a PR you submitted (for example: PR#1221), a feature you have claimed (for example: Claim Issue#133), or the Potato development area you want to help with (for example: Potato frontend, unit tests). Your request will not be approved if none of these is provided.

- **Discord (Developers)**: Please first post one of the three items above in the Potato Discord community. After admin confirmation, you will be invited to the private developer channel.
...
### [GitHub Discussions](https://github.com/fly-go-run/Potato/discussions)
...
### [GitHub Issues](https://github.com/fly-go-run/Potato/issues)
...
- **GitHub**: [fly-go-run/Potato](https://github.com/fly-go-run/Potato) - Star the project for update notifications
