    ...
    <div className="px-4 pb-6 pt-3 sm:px-6">
      ...
      <div className={`relative mx-auto ${widthClass}`}>
        ...
        <div className="overflow-visible">
          <div className="relative z-10 rounded-[var(--radius-lg)] border border-line-strong bg-surface shadow-[var(--shadow-composer)] transition-[border-color,box-shadow] duration-[var(--dur-fast)] focus-within:border-tint focus-within:shadow-[var(--shadow-composer-focus)]">
