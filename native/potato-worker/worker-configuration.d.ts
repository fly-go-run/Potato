/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fd004ea0a716e5940df015ce41adb3e6)
// Runtime types generated with workerd@1.20260911.1 2026-09-12 nodejs_compat
interface __BaseEnv_Env {
	RECALL_BUCKET: R2Bucket;
	SEARCH_RATE_LIMIT: RateLimit;
	SPEECH_RATE_LIMIT: RateLimit;
	SANDBOX_RATE_LIMIT: RateLimit;
	CHAT_RATE_LIMIT: RateLimit;
	REMOTE_RATE_LIMIT: RateLimit;
	RECALL_RATE_LIMIT: RateLimit;
	DOUBAO_RESOURCE_ID: "volc.seedasr.sauc.duration";
	E2B_TEMPLATE: "chat-web-office-pdf";
	UPSTREAM_URL: "https://api.deepseek.com/chat/completions";
	ALLOWED_MODELS: "deepseek-flash";
	MAX_OUTPUT_TOKENS: "4096";
	REMOTE_ACCESS_TEAM: "https://liuxu-cf.cloudflareaccess.com";
	REMOTE_ACCESS_AUD: "3caaf83d896a6d75eb39ef46a87e47ef2b093cc5129995489a789e7757a05310";
	REMOTE_PUBLIC_URL: "https://potato-remote.recodex.top";
	REMOTE_CONTROL_ENABLED: "true";
	CLOUD_ACCESS_AUD: "1bf05234bd56ae3508e5235764cd8b062d75d89ff74bad1bdc710f7203cc2c9a";
	CLIENT_TOKEN: string;
	UPSTREAM_API_KEY: string;
	CHAT_JOBS: DurableObjectNamespace<import("./src/entry").ChatJob>;
	REMOTE_DEVICES: DurableObjectNamespace<import("./src/entry").RemoteDevice>;
	REMOTE_ACCOUNTS: DurableObjectNamespace<import("./src/entry").RemoteAccount>;
	REMOTE_LOGINS: DurableObjectNamespace<import("./src/entry").RemoteLogin>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/entry");
		durableNamespaces: "ChatJob" | "RemoteDevice" | "RemoteAccount" | "RemoteLogin";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DOUBAO_RESOURCE_ID" | "E2B_TEMPLATE" | "UPSTREAM_URL" | "ALLOWED_MODELS" | "MAX_OUTPUT_TOKENS" | "REMOTE_ACCESS_TEAM" | "REMOTE_ACCESS_AUD" | "REMOTE_PUBLIC_URL" | "REMOTE_CONTROL_ENABLED" | "CLOUD_ACCESS_AUD" | "CLIENT_TOKEN" | "UPSTREAM_API_KEY">> {}
}
