...
One-click analysis of Potato startup performance, identify bottlenecks, and provide optimization suggestions.
...
- **Import Time Analysis** - Potato modules and third-party library import time ranking
...
2. **Data Analysis**
   - Parse log files
   - Categorize statistics (Potato/third-party/stdlib)
...
- Python 3.8+
- No extra dependencies (except Potato itself)
- Pure JSON data output
- HTML runs standalone, viewable offline

## Related Tools

- `src/potato/utils/startup_display.py` - Startup banner display
