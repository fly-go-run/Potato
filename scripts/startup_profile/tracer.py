#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Function execution tracer for Potato."""
import json
import time
import traceback
...
class ExecTracer:
    """Trace function execution in potato package."""
...
def main():
    """Run tracer on potato app import."""
    ...
    tracer = ExecTracer(package_names=["potato"])
    sys.settrace(tracer.trace_calls)

    try:
        # Import potato app to trigger startup
        from potato.app._app import (  # pylint: disable=unused-import
            app,
        )  # noqa: F401
    finally:
        sys.settrace(None)
